...
static long longAllFrameSize;  	//֡�����ܺ�(�ļ����ȼ�ȥID3 tag, APE tag �ȳ���)
static long longFrameOffset;    //��һ֡��ƫ����
static long longAllTrackFrames;	//֡��
static double floatFrameDuration;	//һ֡ʱ��(��)
