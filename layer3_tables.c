 ...
 * layer3_tables.c
 *
 * Contains all the lookup tables used by Layer III decoding.
 * These tables were moved from layer3.h to avoid multiple definition errors.
 * This is the ONLY file that includes tables.h to define floatPow2 and floatPowIS.
 */

#include "layer3.h"
#include "tables.h"  // This defines floatPow2 and floatPowIS
...
// Scale factor length table for MPEG 2.0
int slen_tab2[3][6][4] = {
    {
